  ...
  var lib = (function(){
    ...
    */
    function chain(o) {
      ...
      function invoke(method, cb) {
        _this.o = method(_this.o, cb);
        return _this.o;
      }

      function wrapper(fn) {
        return function(cb) {
          return invoke.call(_this, fn, cb);
        }
      }

      var ret = {};

      forOwn(_(), function(v,k,i) {
        _this[k] = wrapper(v);
      });
    ...
    */
    ...
    /**
    * @desc Takes a method and will invoke that method on the any object
    *
    * @func invoker
    * @param {function} function - function
    * @param {number} times - times to repeat
    ...
    *
    * console.log(_.map([[1,2,3],['a','b','c']], reverse)); // [[3,2,1], ['c','b','a']];
    */
    ...
    * }
    *
    * var validNum = zep.checkerInvoker([isNumber, gt3], success, fail);
    *
    * console.log(validNum(5)); // 5 succeeded
    */
    function checkerInvoker(validators, success, fail) {
      return function(/* args */) {
        var args = toArray(arguments);
        var succeed = every(validators, function(check) {
          return check.apply(null, args);
        });
        return functor(succeed ? success : fail).apply(null, args);
      }
    };
    ...
    lib.checker = checker;
    lib.checkerInvoker = checkerInvoker;
    lib.best = best;
